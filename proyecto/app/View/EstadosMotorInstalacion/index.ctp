			...
			<div class="portlet-body form">
				...
				<form action="" class="horizontal-form" method="get">
					...
					<div class="form-actions right">
						<button type="button" class="btn default" onclick="window.location='/EstadosMotor';">Limpiar</button>
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			...
			<span class="caption-subject bold uppercase">Estados Motor Instalación</span>
		</div>
		<div class="tools"> </div>
	</div>
	<div class="portlet-body form">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="dt-buttons">
								<a class="dt-button buttons-print btn dark btn-outline" tabindex="0" aria-controls="table_1" href="/EstadosMotorInstalacion/agregar"><i class="fa fa-plus"></i> <span>Nuevo</span></a>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									<tr>
										<?php echo "<th style=\"width:50px;\">" . $paginator->sort('EstadoMotorInstalacion.id', 'Cód.') . "</th>"; ?>
										<?php echo "<th>" . $paginator->sort('EstadoMotorInstalacion.nombre', 'Estado Motor Instalación') . "</th>"; ?>
										<th align="center">
											<?php
								...
								<?php
									foreach( $registros as $registro ) {
										//print_r($faenas);
										echo "<tr>";
											echo "<td align=\"center\"><input type=\"hidden\" name=\"registro[{$registro['EstadoMotorInstalacion']['id']}]\" value=\"{$registro['EstadoMotorInstalacion']['e']}\">";
											echo "{$registro['EstadoMotorInstalacion']['id']}</td>";
											echo "<td>{$registro['EstadoMotorInstalacion']['nombre']}</td>";
											echo "<td align=\"center\" style=\"width: 60px;\">";
											echo '<div class="form-group" style="margin-bottom: 0;">';
											echo '<div class="mt-checkbox-inline">';
											echo '<label class="mt-checkbox mt-checkbox-outline">';
											if($registro['EstadoMotorInstalacion']['e'] == '1') {
												echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['EstadoMotorInstalacion']['id']}]\" value=\"1\" checked=\"checked\" />";
											} else {
												echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['EstadoMotorInstalacion']['id']}]\" value=\"1\" />";
											}
											echo "<span></span>";
											echo "</label>";
											echo '</div>';
											...
											echo "<td align=\"center\" style=\"width: 80px\">";
												echo $this->Html->link("Editar", array('action' => 'editar', $registro['EstadoMotorInstalacion']['id']), array('class' => 'btn btn-sm blue'));
