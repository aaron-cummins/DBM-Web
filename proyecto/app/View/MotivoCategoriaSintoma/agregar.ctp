							...
							<div class="col-md-4">
								<select class="form-control" name="data[sintoma_id]" required="required"> 
									...
									<?php foreach($sintomas as $key => $value) { ?>
										...
										<option value="<?php echo $value["Sintoma"]["id"];?>">FC <?php echo $value["Sintoma"]["codigo"];?> <?php echo $value["Sintoma"]["nombre"];?></option>
										<?php } else { ?>
										<option value="<?php echo $value["Sintoma"]["id"];?>"><?php echo $value["Sintoma"]["nombre"];?></option>
										<?php } ?>
									<?php } ?>
								</select> 
							</div>
