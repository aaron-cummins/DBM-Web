    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/PrebacklogAlerta" class="horizontal-form" method="get">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    <div class="form-actions right">
                        <button type="button" class="btn default" onclick="window.location = '/PreacklogAlerta';">Limpiar</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-print btn dark" tabindex="0" aria-controls="table_1" href="/PrebacklogAlerta/alerta"><i class="fa fa-plus"></i> <span>Nuevo tipo de Alerta</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12"> 
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <tr>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_alerta.id', 'ID') . "</th>"; ?>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_alerta.nombre', 'Nombre') . "</th>"; ?>
                                        <?php echo "<th>" . $paginator->sort('Criticidad.nombre', 'Criticidad') . "</th>"; ?>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_alerta.fecha_creacion', 'Fecha Creacion') . "</th>"; ?>
                                        <th align="center">
                                        <?php
                                    ...
                                    foreach ($registros as $registro) {
                                        $registro['Prebacklog_alerta']['fecha_creacion'] = strtotime($registro['Prebacklog_alerta']['fecha_creacion']);
                                        $registro['Prebacklog_alerta']['fecha_creacion'] = date("d-m-Y", $registro['Prebacklog_alerta']['fecha_creacion']);


                                        echo "<td align=\"center\"><input type=\"hidden\" name=\"registro[{$registro['Prebacklog_alerta']['id']}]\" value=\"{$registro['Prebacklog_alerta']['e']}\">";
                                        echo "{$registro['Prebacklog_alerta']['id']}</td>";
                                        echo "<td>{$registro['Prebacklog_alerta']['nombre']}</td>";
                                        echo "<td>{$registro['Criticidad']['nombre']}</td>";
                                        echo "<td>{$registro['Prebacklog_alerta']['fecha_creacion']}</td>";
                                        echo "<td align=\"center\" style=\"width: 60px;\">";
                                        echo '<div class="form-group" style="margin-bottom: 0;">';
                                        echo '<div class="mt-checkbox-inline">';
                                        echo '<label class="mt-checkbox mt-checkbox-outline">';
                                        if($registro['Prebacklog_alerta']['e'] == '1') {
                                                echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['Prebacklog_alerta']['id']}]\" value=\"1\" checked=\"checked\" />";
                                        } else {
                                                echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['Prebacklog_alerta']['id']}]\" value=\"1\" />";
                                        }
                                        echo "<span></span>";
                                        echo "</label>";
                                        echo '</div>';
                                        ...
                                        echo "<td align=\"center\" style=\"width: 80px\">";
                                                echo $this->Html->link("Editar", array('action' => 'alerta', $registro['Prebacklog_alerta']['id']), array('class' => 'btn btn-sm blue'));
                                        echo "</td>";
                                        $i++;
                                        echo "</tr>";
                                    }
