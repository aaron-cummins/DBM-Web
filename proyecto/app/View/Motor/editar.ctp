				...
				<form action="" class="horizontal-form" method="post" role="form">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[nombre]" class="form-control" required="required" type="text" id="nombre" value="<?php echo $data["Motor"]["nombre"]; ?>">
							</div>
						</div>
					</div>
					<div class="form-group">
							...
							<div class="col-md-4">
								<select name="data[tipo_admision_id]" class="form-control" type="text" id="tipo_admision_id">
									...
									foreach($tipos_admision as $key => $value) { ?>
										<option value="<?php echo $key;?>" <?php echo $data["Motor"]["tipo_admision_id"] == $key ? 'selected="selected"' : '';?>><?php echo $value;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
							...
							<div class="col-md-4">
								<select name="data[tipo_emision_id]" class="form-control" type="text" id="tipo_emision_id">
									...
									foreach($tipos_emision as $key => $value) { ?>
										<option value="<?php echo $key;?>" <?php echo $data["Motor"]["tipo_emision_id"] == $key ? 'selected="selected"' : '';?>><?php echo $value;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[modelo_motor]" class="form-control" required="required" type="text" id="modelo_motor" readonly="readonly" value="<?php echo $data["Motor"]["nombre"]; ?> <?php echo $data["TipoAdmision"]["nombre"]; ?> <?php echo $data["TipoEmision"]["nombre"]; ?>">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[arreglo_motor]" class="form-control" required="required" type="text" id="arreglo_motor" readonly="readonly" value="<?php echo $data["Motor"]["nombre"]; ?> <?php echo $data["TipoEmision"]["nombre"]; ?>">
							</div>
						</div>
					</div>
					-->
