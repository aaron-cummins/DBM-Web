	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="portlet light bordered">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="/CargaMasiva/Pool" class="horizontal-form" method="post" enctype="multipart/form-data" name="form-file">
					<div class="form-body">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<p class="help-block"> Seleccione un archivo formato XLSX con los siguientes campos: Motor, Sección, Sistema, Subsistema, Nº ID, Elemento, Pool, Condición </p>
								</div>
							</div>
						</div>
					...
					<div class="form-actions right">
						<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Pool';">Cancelar</button>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-equalizer font-blue-hoki"></i>
					<span class="caption-subject font-blue-hoki bold uppercase">Carga masiva pool</span>
					<span class="caption-helper"></span>
				</div>
			</div>
			<div class="portlet-body form">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="pool" class="pool form-control">
										<option value="">Todos</option>
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			...
			<span class="caption-subject bold uppercase">Pool</span>
		</div>
		<div class="tools"></div>
	</div>
	<div class="portlet-body form">
		<form action="/CargaMasiva/Pool" class="horizontal-form" method="post">
			<input type="hidden" name="form-save" value="1" />
			<div id="table_1_wrapper" class="dataTables_wrapper">
				<div class="form-actions right">
					<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Pool';">Cargar nuevo archivo</button>
					<button type="submit" class="btn blue">
							...
							<div class="table-responsive">
								...
								<?php
									...
									foreach($data as $registro) {
										echo "<tr estado_id='{$registro['estado_id']}' motor_id=\"{$registro['motor_id']}\" sistema_id=\"{$registro['sistema_id']}\" subsistema_id=\"{$registro['subsistema_id']}\" pool=\"{$registro['pool']}\" elemento_id=\"{$registro['elemento_id']}\" n_id='".strtolower($registro['n_id'])."' condicion_id='".strtolower($registro['condicion'])."' class='data_row'>";
											...
											echo "<input type=\"hidden\" name=\"pool[$i]\" value=\"{$registro['pool']}\" />";
