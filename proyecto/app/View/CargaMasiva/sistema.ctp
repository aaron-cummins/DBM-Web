		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-blue-hoki bold uppercase">Carga masiva sistema</span>
					<span class="caption-helper"></span>
				</div>
			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="/CargaMasiva/Sistema" class="horizontal-form" method="post" enctype="multipart/form-data" name="form-file">
					<div class="form-body">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<p class="help-block"> Seleccione un archivo formato XLSX con los siguientes campos: Motor, Sección, Sistema, Subsistema, Posición Subsistema, Condición </p>
								</div>
							</div>
						</div>
					...
					<div class="form-actions right">
						<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Sistema';">Cancelar</button>
								...
								<div class="form-group">
									...
									<select name="posicion_id" class="posicion_id form-control">
										...
										<?php foreach($posiciones as $value){
											echo "<option value=\"{$value["Posiciones_Subsistema"]["id"]}\">{$value["Posiciones_Subsistema"]["nombre"]}</option>";	
										} ?>
									</select>
								</div>
							</div>
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			...
			<span class="caption-subject bold uppercase">Sistemas</span>
		</div>
		<div class="tools"></div>
	</div>
	<div class="portlet-body form">
		<form action="/CargaMasiva/Sistema" class="horizontal-form" method="post">
			<input type="hidden" name="form-save" value="1" />
			<div id="table_1_wrapper" class="dataTables_wrapper">
				<div class="form-actions right">
					<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Sistema';">Cargar nuevo archivo</button>
					<button type="submit" class="btn blue">
							...
							<div class="table-responsive">
								...
								<?php
									...
									foreach($data as $registro) {
										echo "<tr estado_id='{$registro['estado_id']}' motor_id=\"{$registro['motor_id']}\" sistema_id=\"{$registro['sistema_id']}\" subsistema_id=\"{$registro['subsistema_id']}\" posicion_id=\"{$registro['posicion_id']}\" condicion_id='".strtolower($registro['condicion'])."' class='data_row'>";
