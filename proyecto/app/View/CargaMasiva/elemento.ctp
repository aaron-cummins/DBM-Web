		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-blue-hoki bold uppercase">Carga masiva elemento</span>
					<span class="caption-helper"></span>
				</div>
			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="/CargaMasiva/Elemento" class="horizontal-form" method="post" enctype="multipart/form-data" name="form-file">
					<div class="form-body">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<p class="help-block"> Seleccione un archivo formato XLSX con los siguientes campos: Motor, Sección, Sistema, Subsistema, Nº ID, Elemento, Posición Elemento, Condición </p>
								</div>
							</div>
						</div>
					...
					<div class="form-actions right">
						<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Elemento';">Cancelar</button>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="posicion_id" class="posicion_id form-control">
										<option value="">Todos</option>
										<?php foreach($posiciones as $value){
											echo "<option value=\"{$value["Posiciones_Elemento"]["id"]}\">{$value["Posiciones_Elemento"]["nombre"]}</option>";	
										} ?>
									</select>
								</div>
							</div>
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			...
			<span class="caption-subject bold uppercase">Elementos</span>
		</div>
		<div class="tools"></div>
	</div>
	<div class="portlet-body form">
		<form action="/CargaMasiva/Elemento" class="horizontal-form" method="post">
			<input type="hidden" name="form-save" value="1" />
			<div id="table_1_wrapper" class="dataTables_wrapper">
				<div class="form-actions right">
					<button type="button" class="btn default" onclick="window.location='/CargaMasiva/Elemento';">Cargar nuevo archivo</button>
					<button type="submit" class="btn blue">
							...
							<div class="table-responsive">
								...
								<?php
									...
									foreach($data as $registro) {
										echo "<tr estado_id='{$registro['estado_id']}' motor_id=\"{$registro['motor_id']}\" sistema_id=\"{$registro['sistema_id']}\" subsistema_id=\"{$registro['subsistema_id']}\" posicion_id=\"{$registro['posicion_id']}\" elemento_id=\"{$registro['elemento_id']}\" n_id='".strtolower($registro['n_id'])."' condicion_id='".strtolower($registro['condicion'])."' class='data_row'>";
											...
											echo "<input type=\"hidden\" name=\"posicion_id[$i]\" value=\"{$registro['posicion_id']}\" />";
											...
											echo "<input type=\"hidden\" name=\"posicion[$i]\" value=\"{$registro['posicion']}\" />";
