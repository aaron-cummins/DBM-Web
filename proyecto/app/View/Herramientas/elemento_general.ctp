...
<div class="wrapper">
	...
	?>
		<fieldset>
		<div class="title"><img src="/images/icons/dark/list.png" alt="" class="titleIcon"><h6>Archivo Elemento-General</h6></div>
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable">
			<tr>
             ...
             <tr>
				<td></td>
                <td>El archivo debe tener formato CSV con las siguientes columnas: Arreglo Motor, Sección, Sistema, Subsistema, N° ID, Elemento, Posición elemento.</td>
				<td></td>
				<td></td>
		  </tr>
			<tr>
...
<?php 
	if (count($this->request->data) && count($data) > 0) {
		echo $this->Form->create('Herramientas', array('action' => 'verificar_elemento_general'));
?>
	 <div class="widget">
		<fieldset>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable">
			...
			<tr>
				...
				<td>Posición Elemento</td>
                <td>
					<select id="aPosicionElemento" class="flCargas">
						<option value="">Mostrar Todo</option>
						<?php
							foreach ($posicioneselementos as $var) { 
								echo "<option value=\"{$var["Posiciones_Elemento"]["id"]}\">{$var["Posiciones_Elemento"]["nombre"]}</option>"."\n"; 
							}
						?>
					</select>
				</td>
	...
	<div class="widget">
		<div class="title"><img src="/images/icons/dark/frames.png" alt="" class="titleIcon"><h6>Archivo Elemento-General</h6></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable tbResultados">
              ...
              <tbody>
				...
				foreach ($data as $fila) {
					...
					echo "<td class=\"posicionelemento\">{$fila["Posicion"]}</td>";
					if ($fila["Accion"] == '') {
				...
				foreach ($existentes as $fila) {
					...
					echo "<td class=\"posicionelemento\">".@$fila["Posicion"]["nombre"]."</td>";
					if (@$fila["Sistema_Subsistema_Motor_Elemento"]["e"] != '1') {
						echo "<td class=\"e\">Inactivo</td>";
						echo "<td><input type=\"checkbox\" name=\"deshacer[]\" class=\"matriz_opciones\" value=\"".@$fila["Sistema_Subsistema_Motor_Elemento"]["id"]."\" title=\"Marcar para deshacer eliminación\" /></td>";
					} else {
						echo "<td class=\"e\">Activo</td>";
						echo "<td><input type=\"checkbox\" name=\"quitar[]\" class=\"matriz_opciones\" value=\"".@$fila["Sistema_Subsistema_Motor_Elemento"]["id"]."\" title=\"Marcar para eliminar\" /></td>";
					}
					echo "</tr>";
				}
				?>
