			...
			<div class="portlet-body form">
				...
				<form action="" class="horizontal-form" method="get">
					...
					<div class="form-actions right">
						<button type="button" class="btn default" onclick="window.location='/CategoriaTecnico';">Limpiar</button>
...
<div class="portlet light">
	<div class="portlet-title">
		<div class="caption font-dark">
			...
			<span class="caption-subject bold uppercase">Categorías Técnicos</span>
		</div>
		<div class="tools"> </div>
	</div>
	<div class="portlet-body form">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="dt-buttons">
								<a class="dt-button buttons-print btn dark btn-outline" tabindex="0" aria-controls="table_1" href="/CategoriaTecnico/agregar"><i class="fa fa-plus"></i> <span>Nuevo</span></a>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									<tr>
										<?php echo "<th style=\"width:50px;\">" . $paginator->sort('TipoTecnico.id', 'Cód.') . "</th>";?>
										<?php echo "<th>" . $paginator->sort('TipoTecnico.nombre', 'Categoría Técnico') . "</th>";?>
										<?php echo "<th>" . $paginator->sort('TipoTecnico.nombre', 'Requerido') . "</th>";?>
										<?php echo "<th>" . $paginator->sort('TipoTecnico.nombre', 'Único') . "</th>";?>
										<?php echo "<th>" . $paginator->sort('TipoTecnico.nombre', 'Firma') . "</th>";?>
										<th align="center">
											<?php
								...
								<?php
									foreach( $registros as $registro ) {
										echo "<tr>";
											...
											echo '<div class="mt-checkbox-inline">';
											echo '<label class="mt-checkbox mt-checkbox-outline">';
											if($registro['TipoTecnico']['requerido'] == '1') {
												echo "<input type=\"checkbox\" class=\"check-requerido\" name=\"requerido[{$registro['TipoTecnico']['id']}]\" value=\"1\" checked=\"checked\" />";
											} else {
												echo "<input type=\"checkbox\" class=\" check-requerido\" name=\"requerido[{$registro['TipoTecnico']['id']}]\" value=\"1\" />";
											}
											echo "<span></span>";
											echo "</label>";
											echo '</div>';
											...
											echo '<div class="mt-checkbox-inline">';
											echo '<label class="mt-checkbox mt-checkbox-outline">';
											if($registro['TipoTecnico']['unico'] == '1') {
												echo "<input type=\"checkbox\" class=\" check-unico\" name=\"unico[{$registro['TipoTecnico']['id']}]\" id=\"c_{$registro['TipoTecnico']['id']}\" value=\"1\" checked=\"checked\" />";
											} else {
												echo "<input type=\"checkbox\" class=\" check-unico\" name=\"unico[{$registro['TipoTecnico']['id']}]\" id=\"c_{$registro['TipoTecnico']['id']}\" value=\"1\" />";
											}
											echo "<span></span>";
											echo "</label>";
											echo '</div>';
											...
											if($registro['TipoTecnico']['firma'] == '1') {
												echo "<input type=\"checkbox\" class=\"check-firma\" name=\"firma[{$registro['TipoTecnico']['id']}]\" id=\"fc_{$registro['TipoTecnico']['id']}\" value=\"1\" checked=\"checked\" $disabled />";
											} else {
												echo "<input type=\"checkbox\" class=\" check-firma\" name=\"firma[{$registro['TipoTecnico']['id']}]\" id=\"fc_{$registro['TipoTecnico']['id']}\" value=\"1\" $disabled />";
											}
											echo "<span></span>";
											echo "</label>";
											echo '</div>';
											...
											echo '<div class="mt-checkbox-inline">';
											echo '<label class="mt-checkbox mt-checkbox-outline">';
											if($registro['TipoTecnico']['e'] == '1') {
												echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['TipoTecnico']['id']}]\" value=\"1\" checked=\"checked\" />";
											} else {
												echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['TipoTecnico']['id']}]\" value=\"1\" />";
											}
											echo "<span></span>";
											echo "</label>";
											echo '</div>';
											...
											echo "<td align=\"center\" style=\"width: 80px\">";
												echo $this->Html->link("Editar", array('action' => 'editar', $registro['TipoTecnico']['id']), array('class' => 'btn btn-sm blue'));
											echo "</td>";
										echo "</tr>";
									}
								?>
