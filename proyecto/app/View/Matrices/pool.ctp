...
<div class="wrapper">
       <form method="GET" action="/matrices/pool">
       <div class="widget">
              ...
              <tbody>
				<tr>
					...
					<td align="right" colspan="4">
						<input type="button" name="filtro_limpiar" value="Limpiar" class="greyishB" onclick="window.location='/matrices/pool'; return false;" />
	...
	<form method="GET" action="/matrices/pool/up">
<div class="wrapper">
	<div class="widget">
	<?php
		if (count($resultado)>0) { 
	?>
		<div class="title"><img src="/images/icons/dark/frames.png" alt="" class="titleIcon"><h6>Pool de Elementos</h6></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
              <thead>
                  <tr>
					  <?php echo "<td  style=\"width: 30px;\">" . $paginator->sort('ElementoPool.id', 'Código') . "</td>";?>
                      ...
                      <?php echo "<td width=\"30\">" . $paginator->sort('ElementoPool.codigo', 'ID') . "</td>";?>
					  <?php echo "<td>" . $paginator->sort('Elemento.nombre', 'Elemento') . "</td>";?>
					  <?php echo "<td width=\"30\">" . $paginator->sort('ElementoPool.e', 'Estado') . "</td>";?>
              ...
              <tbody>
				...
				?>
					<tr>
						<td><?php echo $v["ElementoPool"]["id"];?></td>
						<td><?php echo $v["Motor"]["nombre"];?></td>
						<td><?php echo $v["Sistema"]["nombre"];?></td>
						<td><?php echo $v["Subsistema"]["nombre"];?></td>
						<td><?php echo $v["ElementoPool"]["codigo"];?></td>
                        <td><?php echo $v["Elemento"]["nombre"];?></td>
						<td align="center">
							<?php if($v["ElementoPool"]["e"]=='1'){?>
							<!--<a href="/Matrices/elementos/<?php echo $v["ElementoPool"]["id"];?>/0">-->
								<img src="/images/icons/control/32/check.png" width="20" />
							<!--</a>-->
							<?php }?>
							<?php if($v["ElementoPool"]["e"]=='0'){?>
							<!--<a href="/Matrices/elementos/<?php echo $v["ElementoPool"]["id"];?>/1">-->
								<img src="/images/icons/control/32/check.png" width="20" style="opacity:0.2;" />
							<!--</a>-->
							<?php }?>
							<td>
							<input type="checkbox" name="reg[]" value="<?php echo $v["ElementoPool"]["id"];?>" />
						</td>
						</td>
					</tr>
				<?php
