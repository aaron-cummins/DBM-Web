									...
									<select class="form-control" name="motor_id" required="required">
										...
										<?php
											foreach ($motores as $motor) { 
												echo "<option value=\"{$motor["Motor"]["id"]}\">{$motor["Motor"]["nombre"]} {$motor["TipoEmision"]["nombre"]}</option>"."\n"; 
											}
										?>									</select> 
								</div>
							</div>
									...
									<select class="form-control" name="sistema_id" required="required">
										...
										<?php
											foreach ($sistemas as $sistema) { 
												echo "<option value=\"{$sistema["Sistema"]["id"]}\">{$sistema["Sistema"]["nombre"]}</option>"."\n"; 
											}
										?>
									</select> 
								</div>
									...
									<select class="form-control" name="subsistema_id" required="required">
										...
										<?php
											foreach ($subsistemas as $subsistema) { 
												echo "<option value=\"{$subsistema["Subsistema"]["id"]}\">{$subsistema["Subsistema"]["nombre"]}</option>"."\n"; 
											}
										?>
									</select> 
								</div>
									...
									<select class="form-control" name="elemento_id" required="required">
										...
										<?php
											foreach ($elementos as $elemento) { 
												echo "<option value=\"{$elemento["Elemento"]["id"]}\">{$elemento["Elemento"]["nombre"]}</option>"."\n"; 
											}
										?>
									</select> 
								</div>
