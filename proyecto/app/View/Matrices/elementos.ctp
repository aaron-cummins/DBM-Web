...
<div class="wrapper">
       <form method="GET" action="/matrices/elementos">
       <div class="widget">
              ...
              <tbody>
				<tr>
						...
						<select name="pid" id="pid">
							...
							<?php
								foreach ($posiciones as $posicion) { 
									echo "<option value=\"{$posicion["Posiciones_Elemento"]["id"]}\" ".(($posicion_id==$posicion["Posiciones_Elemento"]["id"]) ? 'selected="selected"' : '').">{$posicion["Posiciones_Elemento"]["nombre"]}</option>"."\n"; 
								}
							?>
						</select>
					</td>
                    ...
                    <tr>
						...
						<td>N° ID</td>
						<td><input id="codigo" type="text" name="codigo" value="<?php echo $codigo;?>" /></td>
                    </tr>
                    <tr>
						<td>Estado</td>
						<td>
					...
					<td align="right" colspan="4">
						<input type="button" name="filtro_limpiar" value="Limpiar" class="greyishB" onclick="window.location='/matrices/elementos'; return false;" />
	...
	<form method="GET" action="/matrices/elementos/up">
<div class="wrapper">
	<div class="widget">
	<?php
		if (count($resultado)>0) { 
	?>
		<div class="title"><img src="/images/icons/dark/frames.png" alt="" class="titleIcon"><h6>ELEMENTOS</h6></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
              <thead>
                  <tr>
					  <?php echo "<td  style=\"width: 30px;\">" . $paginator->sort('Sistema_Subsistema_Motor_Elemento.id', 'Código') . "</td>";?>
                      ...
                      <?php echo "<td width=\"30\">" . $paginator->sort('Sistema_Subsistema_Motor_Elemento.codigo', 'ID') . "</td>";?>
					  <?php echo "<td>" . $paginator->sort('Elemento.nombre', 'Elemento') . "</td>";?>
					  <?php echo "<td>" . $paginator->sort('Posicion.nombre', 'Posicion') . "</td>";?>
					  <?php echo "<td width=\"30\">" . $paginator->sort('Sistema_Subsistema_Motor_Elemento.e', 'Estado') . "</td>";?>
              ...
              <tbody>
				...
				?>
					<tr>
						<td><?php echo $v["Sistema_Subsistema_Motor_Elemento"]["id"];?></td>
						<td><?php echo $v["Motor"]["nombre"];?></td>
						<td><?php echo $v["Sistema"]["nombre"];?></td>
						<td><?php echo $v["Subsistema"]["nombre"];?></td>
						<td><?php echo $v["Sistema_Subsistema_Motor_Elemento"]["codigo"];?></td>
                        <td><?php echo $v["Elemento"]["nombre"];?></td>
						<td><?php echo $v["Posicion"]["nombre"];?></td>
						<td align="center">
							<?php if($v["Sistema_Subsistema_Motor_Elemento"]["e"]=='1'){?>
							<!--<a href="/Matrices/elementos/<?php echo $v["Sistema_Subsistema_Motor_Elemento"]["id"];?>/0">-->
								<img src="/images/icons/control/32/check.png" width="20" />
							<!--</a>-->
							<?php }?>
							<?php if($v["Sistema_Subsistema_Motor_Elemento"]["e"]=='0'){?>
							<!--<a href="/Matrices/elementos/<?php echo $v["Sistema_Subsistema_Motor_Elemento"]["id"];?>/1">-->
								<img src="/images/icons/control/32/check.png" width="20" style="opacity:0.2;" />
							<!--</a>-->
							<?php }?>
							<td>
							<input type="checkbox" name="reg[]" value="<?php echo $v["Sistema_Subsistema_Motor_Elemento"]["id"];?>" />
						</td>
						</td>
					</tr>
				<?php
