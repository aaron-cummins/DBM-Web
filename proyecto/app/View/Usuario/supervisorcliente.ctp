...
<div class="titleArea">
  <div class="wrapper">
		<div class="pageTitle">
			<h5>Usuarios Supervisor Cliente</h5>
		</div>
	  <div class="clear"></div>
	</div>
</div>
...
<div class="wrapper">
	...
	?>
		<div class="title"><img src="/images/icons/dark/frames.png" alt="" class="titleIcon"><h6>Usuarios perfil SUPERVISOR CLIENTE existentes en el sistema</h6></div>
				...
				?>
					<tr>
						...
						<td align="center">
							...
							<a href="/Usuario/supervisorcliente/<?php echo $usuario["UsuarioNivel"]["id"];?>/0">
								<img src="/images/icons/control/32/user.png" width="20" title="Click para desactivar" />
							</a>
							<?php }?>
							<?php if($usuario["UsuarioNivel"]["e"]=='0'){?>
							<a href="/Usuario/supervisorcliente/<?php echo $usuario["UsuarioNivel"]["id"];?>/1">
