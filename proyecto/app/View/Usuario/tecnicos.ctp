...
<div class="wrapper">
	...
	?>
		<div class="title"><img src="/images/icons/dark/frames.png" alt="" class="titleIcon"><h6>Usuarios perfil TÉCNICO existentes en el sistema</h6></div>
              ...
              <tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $usuario["Faena"]["nombre"];?></td>
						<td>Técnico</td>
						<td align="center">
							<?php if($usuario["Usuario"]["e"]=='1'){?>
							<a href="/Usuario/tecnicos/<?php echo $usuario["Usuario"]["id"];?>/0">
								<img src="/images/icons/control/32/user.png" width="20" title="Click para desactivar" />
							</a>
							<?php }?>
							<?php if($usuario["Usuario"]["e"]=='0'){?>
							<a href="/Usuario/tecnicos/<?php echo $usuario["Usuario"]["id"];?>/1">
