				...
				<form action="" class="horizontal-form" method="post" role="form">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[nombre]" class="form-control" required="required" type="text" id="nombre" value="<?php echo $data["Flota"]["nombre"]; ?>">
							</div>
						</div>
					</div>	
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[aplicacion]" class="form-control" required="required" type="text" id="aplicacion" value="<?php echo $data["Flota"]["aplicacion"]; ?>">
							</div>
						</div>
					</div>	
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[oem]" class="form-control" required="required" type="text" id="oem" value="<?php echo $data["Flota"]["oem"]; ?>">
							</div>
						</div>
					</div>	
					<div class="row">
