...
<html lang="es">
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                                            ...
                                            <ul class="dropdown-menu pull-left">
                                                ...
                                                <?php
                                                if ($app->check_permissions_menu_item("CategoriaTecnico", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                        ...
                                                        $app->check_permissions_menu_item("MedicionComponente", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                        $app->check_permissions_menu_item("Medicion", "mediciones", $faena_session, $usuario_id, $cargos) == TRUE
                                                ) {
                                                    ?>
                                                    <li aria-haspopup="true" class="dropdown-submenu">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <?php
                                                            if ($app->check_permissions_menu_item("CargaMasiva", "Usuario", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("CuadroMando", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("Usuario", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("Cargo", "Index", $faena_session, $usuario_id, $cargos) == TRUE
                                                            ) {
                                                            ...
                                                            <?php
                                                            if ($app->check_permissions_menu_item("Contratos", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("EstadosEquipo", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("EstadosMotor", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("EstadosMotorInstalacion", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("Faena", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                            ...
                                                            <?php
                                                            if ($app->check_permissions_menu_item("Fluidos", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("FluidoUnidad", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                    $app->check_permissions_menu_item("FluidoIngreso", "Index", $faena_session, $usuario_id, $cargos) == TRUE) {
                                                                ?>
                                                                <li aria-haspopup="true" class="dropdown-submenu">
        ...
        <?php }  ?>
                                                            ...
                                                            <?php if ($app->check_permissions_menu_item("Administracion", "Folio", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class="">
                                                                    ...
                                                                    <?php
                                                                    if ($app->check_permissions_menu_item("MedicionComponente", "Index", $faena_session, $usuario_id, $cargos) == TRUE || $app->check_permissions_menu_item("Medicion", "mediciones", $faena_session, $usuario_id, $cargos) == TRUE
                                                                    ) {
                                                                        ?>
                                                                <li aria-haspopup="true" class="dropdown-submenu">
                                                                    <a href="javascript:;" class="nav-link ">Mediciones
                                                                        <span class="arrow"></span>
                                                                    </a>
                                                                    <ul class="dropdown-menu">
        <?php if ($app->check_permissions_menu_item("Medicion", "mediciones", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                            <li aria-haspopup="true" class=" ">
                                                                                <a href="/Medicion/mediciones" class="nav-link ">Mediciones</a>
                                                                            </li>
        <?php } ?>
                                                                <?php if ($app->check_permissions_menu_item("MedicionComponente", "Index", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                            <li aria-haspopup="true" class=" ">
                                                                                <a href="/MedicionComponente/Index" class="nav-link ">Componentes a medir</a>
                                                                            </li>
                                                                <?php } ?>
                                                                    </ul>
                                                                </li>
    <?php } ?>
                                                                    ...
                                                                    <?php
                                                                    if ($app->check_permissions_menu_item("CargaMasiva", "Diagnostico", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                            $app->check_permissions_menu_item("CargaMasiva", "Elemento", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                            $app->check_permissions_menu_item("CargaMasiva", "Pool", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                            $app->check_permissions_menu_item("CargaMasiva", "Sistema", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                                            $app->check_permissions_menu_item("Administracion", "Imagenes", $faena_session, $usuario_id, $cargos) == TRUE ||
    ...
    <?php
    if ($app->check_permissions_menu_item("CategoriaSintoma", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
            $app->check_permissions_menu_item("MotivoLlamado", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
            $app->check_permissions_menu_item("Sintoma", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
            $app->check_permissions_menu_item("CargaMasiva", "Sintoma", $faena_session, $usuario_id, $cargos) == TRUE ||
            $app->check_permissions_menu_item("MotivoCategoriaSintoma", "Index", $faena_session, $usuario_id, $cargos) == TRUE) {
    ...
    <?php } ?>
                                                ...
                                                <?php
                                                if ($app->check_permissions_menu_item("Prebacklog", "index", $faena_session, $usuario_id, $cargos) == TRUE) {
                                                    ?>
                                                    <li aria-haspopup="true" class="dropdown-submenu ">
                                                        <a href="javascript:;" class="nav-link nav-toggle ">
                                                            <i class="fa fa-"></i> Prebacklogs
                                                            <span class="arrow"></span>
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                    <?php if ($app->check_permissions_menu_item("Prebacklog", "index", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class=" ">
                                                                    <a href="/Prebacklog/index" class="nav-link ">Prebacklog Parámetros</a>
                                                                </li>
                                                <?php } ?>
                                                <?php if ($app->check_permissions_menu_item("Prebacklog", "aceite", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class=" ">
                                                                    <a href="/Prebacklog/aceite" class="nav-link ">Prebacklog Aceite</a>
                                                                </li>
                                                    <?php } ?>
                                                    <?php if ($app->check_permissions_menu_item("Prebacklog", "Administracion", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class="dropdown-submenu">
                                                                    <a href="javascript:;" class="nav-link nav-toggle">Administrar
                                                                        <span class="arrow"></span>
                                                                    </a>
                                                                    <ul class="dropdown-menu">
                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogAlerta/index" class="nav-link ">Alerta</a>
                                                                        </li>

                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogAlertaParametro/index" class="nav-link ">Alerta Parámetro</a>
                                                                        </li>
                                                                        
                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogCategoria/index" class="nav-link ">Categorías</a>
                                                                        </li>
                                                                        
                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogMotivoAceite/index" class="nav-link ">Motivo aceites</a>
                                                                        </li>
                                                                        
                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogMotivoCierre/index" class="nav-link ">Motivo cierre</a>
                                                                        </li>
                                                                        
                                                                        <li aria-haspopup="true" class=" ">
                                                                            <a href="/PrebacklogEnvioEmail/index" class="nav-link ">Receptores (email)</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                <?php } ?>
                                                ...
                                                <?php } ?>
                                                <?php
                                                if ($app->check_permissions_menu_item("Backlog", "Index", $faena_session, $usuario_id, $cargos) == TRUE ||
                                                    ...
                                                    <?php if ($app->check_permissions_menu_item("PlanAccion", "Index", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                        <li aria-haspopup="true" class=" ">
                                                            <a href="/PlanAccion" class="nav-link ">Plan de acción</a>
                                                        </li>
                                                    <?php } ?>
...
<?php } ?>
                                                        ...
                                                        <?php if ($app->check_permissions_menu_item("Medicion", "Index", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                    <li aria-haspopup="true" class="dropdown ">
                                                        <a href="/Medicion/index" class="nav-link nav-toggle ">
                                                            <i class="fa fa-"></i> Medición
                                                            <span class="arrow"></span> 
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <?php
                                                if ($app->check_permissions_menu_item("Unidad", "Crear", $faena_session, $usuario_id, $cargos) == TRUE  ||
...
<?php } ?>
                                                    ...
                                                    <li aria-haspopup="true" class="dropdown ">
                                                        <a href="/Trabajo/Planifica_masivo" class="nav-link nav-toggle ">
...
<?php
if (($app->check_permissions_menu_item("Reporte", "Base", $faena_session, $usuario_id, $cargos) == TRUE) ||
        ($app->check_permissions_menu_item("InformeReparacion", "Informe", $faena_session, $usuario_id, $cargos) == TRUE) ||
        ($app->check_permissions_menu_item("InformeConciliacion", "Index", $faena_session, $usuario_id, $cargos) == TRUE)) {
    ?>
                                                    <li aria-haspopup="true" class="dropdown-submenu ">
                                                        <a href="javascript:;" class="nav-link nav-toggle ">
    ...
    <?php if ($app->check_permissions_menu_item("InformeReparacion", "Informe", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class=" ">
                                                                    <a href="/InformeReparacion/Informe" class="nav-link ">Informe de Reparación</a>
                                                                </li>
    <?php } ?>
    <?php if ($app->check_permissions_menu_item("InformeConciliacion", "Index", $faena_session, $usuario_id, $cargos) == TRUE) { ?>
                                                                <li aria-haspopup="true" class=" ">
                                                                    <a href="/InformeConciliacion/Index" class="nav-link ">Informe de Conciliación</a>
                                                                </li>
    <?php } ?>
                                                        </ul>
                                                    </li>
                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            <div id="cargando" style="visibility:hidden; display: flex; position: fixed; top: 0; bottom:0; left: 0; right: 0; overflow: auto; z-index: 10000; background-color:gray; opacity: 70%;  align-items: center; justify-content: center;">
...
if (isset($tipo_evento)) {
    ?>
                                                    $("#tipo_evento").val('<?php echo $_GET['tipo_evento']//$tipo_evento; ?>');
                                                    $("#tipo_evento").change();
    <?php
}
?>
                                                    ...
                                                    if (val == "S") {
                                                        ...
                                                        $.get("/Backlog/select/" + unidad_id, function (data) {
                                                            ...
                                                            $.each(obj, function (i, item) {
                                                                ...
                                                                html += "<option data-content=\"F-" + item.Backlog.id + " | <span class='label label-" + style + "'>" + criticidad + "</span> " + fecha + " | " + responsable + " | " + item.Sistema.nombre + "\" descripcion=\"" + item.Backlog.comentario + "\" sintoma_id=" + item.Backlog.sintoma_id + " categoria_sintoma_id=" + item.Backlog.categoria_sintoma_id + " value=\"" + item.Backlog.id + "\"></option>\n";
...
<?php } ?>
                                                ...
                                                $select.on('change', () => {
                                                    ...
                                                    $select.children(':selected').each((idx, el) => {
                                                        ...
                                                        selecteds.push({
                                                            ...
                                                            categoria_sintoma_id: el.getAttribute("categoria_sintoma_id"),
                                                            sintoma_id: el.getAttribute("sintoma_id")
                                                        });
                                                    });
                                                    $("#informacion_backlog").val("");
                                                    var informacion = "";
                                                    ...
                                                    if(selecteds.length >= 1){
                                                        if(selecteds[0]['categoria_sintoma_id']!='undefined' && selecteds[0]['categoria_sintoma_id'] != 'null' && selecteds[0]['categoria_sintoma_id'] != '') {
                                                            $("#categoria_sintoma_id").val(selecteds[0]['categoria_sintoma_id']);
                                                        ...
                                                        if(selecteds[0]['sintoma_id'] != 'undefined' && selecteds[0]['sintoma_id'] != 'null' && selecteds[0]['sintoma_id'] != '') {
                                                            $("#sintoma_id").val(selecteds[0]['sintoma_id']);
                                                            $("#sintoma_id").change();
                                                        }else{
                                                            $("#sintoma_id").val("");
                                                            $("#sintoma_id").change();
                                                ...
                                                $("#unidad_id").change(function () {
                                                    ...
                                                    if (val != "") {
                                                        ...
                                                        $.get("/Select/getSistema/" + motor_id, function (data) {
                                                            var obj = $.parseJSON(data);
                                                            $.each(obj, function (i, item) {
                                                                html += "<option value=\"" + item.Sistema.id + "\">" + item.Sistema.nombre + "</option>\n";
                                                            });
                                                            $("#sistema_id").html(html);
                                                            //$("#sistema_id").change();
                                                        ...
                                                        html2 = "<option value=\"0\">No aplica</opcion>\n";
                                                        $.get("/Select/getPlanesDeAccion/" + motor_id, function (data) {
                                                            var obj = $.parseJSON(data);
                                                            $.each(obj, function (i, item) {
                                                                html2 += "<option value=\"" + item.PlanAccion.id + "\">" + item.PlanAccion.id + " - " + item.PlanAccion.nombre + "</option>\n";
                                                            });
                                                            $("#plan_accion_id").html(html2);

                                                            <?php if (isset($plan_accion_id)) { ?>
                                                                $("#plan_accion_id").val('<?php echo $plan_accion_id; ?>');
                                                            <?php } ?>
                                                ...
                                                $("#plan_accion_id").change(function () {
                                                    var html = "";
                                                    var id = $("#id").val();
                                                    var folio = $("#folio").val();
                                                    var val = $("#plan_accion_id").val();
                                                    var creacion = $("#creacion_id").val();
                                                    var unidades = $("#unidad_ids").val();
                                                    var criticidad = $("#criticidad_id").val();
                                                    var responsable = $("#responsable_id").val();
                                                    var comentario = $("#comentario").val();
                                                    var tiempo_h = $("#tiempo_estimado_hora").val();
                                                    var tiempo_m = $("#tiempo_estimado_minuto").val();

                                                    if (val != "") {
                                                        document.getElementById('cargando').style.visibility='visible'
                                                        window.location.href  = "/Backlog/web?id="+id+"&folio="+folio+"&idPlanaccion="+val+"&creacion="+creacion+"&unidades="+unidades+
                                                            "&criticidad="+criticidad+"&responsable="+responsable+"&comentario="+comentario+"&t_h="+tiempo_h+"&t_m="+tiempo_m+"&validationes=S4lV4DoR%C4m1l4YA4r0N-ANZR6hkai1DCC";
                                                    }
                                                });
                                                ...
                                                $("#flota_id").change(function () {
                                                    ...
                                                    html = "";
                                                    html += "<option value=\"\">Seleccione una opción</opcion>\n";
                                                    $('#unidad_ids').selectpicker('refresh');
                                                    $.get("/Unidad/selectunidad/" + flota_id, function (data) {
                                                        var obj = $.parseJSON(data);
                                                        $.each(obj, function (i, item) {
                                                            html += "<option value='" + item.Unidad.faena_id + "_" + item.Unidad.flota_id + "_" + item.Unidad.id + "'  faena_flota='" + item.Unidad.faena_id + "_" + item.Unidad.flota_id + "' motor_id='" + item.Unidad.motor_id + "'>" + item.Unidad.unidad + "</option>\n";
                                                        });
                                                        $("#unidad_ids").html(html);
                                                        $('#unidad_ids').selectpicker('refresh');
                                                    });
                                                });
                                                ...
                                                $(".btn-submit2").click(function () {
                                                    if ($("#correlativo_cierra").val() != '') {
                                                        $('#alerta_corr').hide();
                                                        $("#correlativo").val($("#correlativo_cierra").val());
                                                        $("#motivo_desactivado").val($("#motivo_desactivado_").val());
                                                        $("#form-backlogs").submit();
                                                    } else {
                                                        $("#alerta_corr").show();
                                                ...
                                                $(".btn-submit3").click(function () {
                                                    if ($("#motivo_desactivado_").val() != '') {
                                                        $('#alerta_desactiva').hide();
                                                        $("#correlativo").val($("#correlativo_").val());
                                                        $("#motivo_desactivado").val($("#motivo_desactivado_").val());
                                                        $("#form-backlogs").submit();
                                                    } else {
                                                        $("#alerta_desactiva").show();
                                                    }
                                                });
...
<?php } ?>
                                                        ...
                                                        <?php if (@$seccion != "MatrizMotor" && @$seccion != "AdministracionImagenes") { ?>
                                                            ...
                                                            $("#sistema_id").change(function () {
                                                                ...
                                                                var motor_id = $("#unidad_id").find("option:selected").attr("motor_id") ? $("#unidad_id").find("option:selected").attr("motor_id") : $("#motor_id_").find("option:selected").val();

                                                                var id_sub = $("#subsistema_id").val();
                                                                var html = '';
                                                                if (sistema_id != "") {
                                                                    html += "<option value=\"\">Seleccione una opción</opcion>\n";
...
<?php if (@$seccion != "MatrizMotor") { ?>
                                                            ...
                                                            $("#elemento_id").change(function () {
                                                                ...
                                                                if (sistema_id != 0 && motor_id != 0 && subsistema_id != 0 && elemento_id != 0) {
...
<?php if (isset($seccion) && $seccion == 'RevisiónDCC') { ?>
                                                                ...
                                                                if ($("#tipointervencion").val() != 'MP') {
                                                                    if ($("#i_i_f") != null && $("#i_i_f") != undefined && $("#i_i_f").val() != "" && $("#i_i_f").val() != undefined) {
                                                                        if ($("#i_t_f") != null && $("#i_t_f") != undefined && $("#i_t_f").val() != "" && $("#i_t_f").val() != undefined) {
                                                                            ...
                                                                            /** Valida que el diagnostico de falla tenga tiempo, un responsable y un comentario asignado **/
                                                                            let df_h = $("#delta_hora19").val();
                                                                            let df_m = $("#delta_minuto19").val();
                                                                            let df_r = $("#delta_responsable19").val();
                                                                            let df_c = $("#delta_observacion19").val();

                                                                            if(df_h == 0 && df_m == 0){
                                                                                $(".d3_diag").text("Debe tener tiempo asignado.");
                                                                                deltaDiagnosico = 1;
                                                                            }else{
                                                                                if(df_r != 0){
                                                                                    if(df_c != ""){
                                                                                        ...
                                                                                        $(".d3_diag").text("Debe ingresar una observación o comentario.");
                                                                                        deltaDiagnosico = 1;
                                                                                    }
                                                                                }else{
                                                                                    $(".d3_diag").text("Debe debe asignar un responsable.");
                                                                                    deltaDiagnosico = 1;
                                                                                }
                                                                            }
                                                                ...
                                                                if (($('#inicio_delta_fecha') != null) && ($('#inicio_delta_fecha') != undefined) && ($("#inicio_delta_fecha").val() != "") && ($("#inicio_delta_fecha").val() != undefined)) {
                                                                    if ($("#termino_turno_fecha") != null && $("#termino_turno_fecha") != undefined && $("#termino_turno_fecha").val() != "" && $("#termino_turno_fecha").val() != undefined) {
                                                                        if ($("#termino_turno_fecha").val() != "" && $("#termino_turno_hora").val() != "" && $("#termino_turno_minuto").val() != "" && $("#termino_turno_periodo").val() != "") {
                                                                            ...
                                                                            //Agregado por victor Smith -Inicio
                                                                            var hours = Math.floor(d / 60);
                                                                            var minutes = d % 60;

                                                                            if (hours == 0 && minutes == 0) {
                                                                                $("#d9_ing").text("Sin tiempo ingresado");
                                                                            } else if (hours >= 0 && minutes >= 0) {
                                                                                if (hours == 0) {
                                                                                    $("#d9_ing").text("Ha ingresado " + hours + " h y " + minutes + " m");
                                                                                } else if (minutes == 0) {
                                                                                    $("#d9_ing").text("Ha ingresado " + hours + " h y " + minutes + " m");
                                                                                } else {
                                                                                    $("#d9_ing").text("Ha ingresado " + hours + " h y " + minutes + " m");
                                                                            ...
                                                                            /**
                                                                             console.log('total : ' + d)
                                                                             console.log('hora: ' + hours + ' minutos: ' + minutes );
                                                                             //
                                                            ...
                                                            $(".submit-guardar").click(function () {
                                                                ...
                                                                /** Validación de sintoma, debe ser distint a motor **/
                                                                //console.log("sintoma", $("#sintoma_id").val());
                                                                if($("#sintoma_id").val() == 293){
                                                                    $(".mensaje_modal").text("El síntoma debe ser distinto de Motor.");
                                                                    $('#modal_mensaje_error').modal('show');
                                                                    $("#sintoma_id").addClass("has-error");
                                                                    return false;
                                                                }
                                                                /** Fin Validación de sintoma motor*/
                                                                ...
                                                                if (deltaDiagnosico != 0) {
                                                                    $(".mensaje_modal").text("Debe corregir los problemas con el item 'diagnóstico de falla' (Detalle inicio y término de la intervención)");
                                                                    $('#modal_mensaje_error').modal('show');
                                                                    //console.log("Delta5 incorrecto");
                                                                    return false;
                                                                }
                                                                ...
                                                                if (totalDelta9 != 0) {
                                                                    $(".mensaje_modal").text("La información ingresada en Detalle tiempo adicional a la bitácora no es correcta, por favor revisar.");
                                                                    $('#modal_mensaje_error').modal('show');
                                                                    //console.log("Delta9 incorrecto");
                                                                    return false;
                                                                }
                                                                ...
                                                                if (delta_negativo) {
                                                                    $(".mensaje_modal").text("No puede asignar valores de deltas negativos.");
                                                                    $('#modal_mensaje_error').modal('show');
                                                                    return false;
                                                                }
                                                                ...
                                                                // Agregado por Victor Smith
                                                                // Estas validaciones existe cuando el flujo de la operación es 'NO'
                                                                if ($('#yes_no_option').val() == '1') {
                                                                    delta_ok = true;
                                                                    delta_negativo = false;
                                                                    /**
                                                                     * Delta 9 [Agregado por Victor Smith]
                                                                ...
                                                                if (fecha_inicio_global == '' || fecha_inicio_global.getFullYear == 1969 || fecha_inicio_global.getFullYear == 1970) {
                                                                    fecha_inicio_global = $("#fecha_i_g").val();
                                                                }

                                                                if (fecha_termino_global == '' || fecha_termino_global.getFullYear == 1969 || fecha_termino_global.getFullYear == 1970) {
                                                                    fecha_termino_global = $("#fecha_t_g").val();
                                                                }

                                                                tiempo_total = fecha_termino_global - fecha_inicio_global;
                                                                ...
                                                                /** verifica elemento falla **/
                                                                let tipocombo = $("#tipointervencion").val();
                                                                if(tipocombo == "RI" || tipocombo == "RP"){
                                                                    let tipo_falla_count = 0;
                                                                    let tipo_falla_elemento = 0;
                                                                    let tipo_falla_diagnostico = 0;
                                                                    let tipo_falla_solucion = "";
                                                                    ...
                                                                    $(".tipo-id").each(function () {
                                                                        ...
                                                                        let id = this.id;
                                                                       if(val != "" && val == 1){
                                                                           let id_el = id.replace("tipo-id", "elemento-id");
                                                                           let id_diag =  id.replace("tipo-id", "diagnostico-id");
                                                                           let id_sol =  id.replace("tipo-id", "solucion-id");

                                                                           let val_el = $("#"+id_el).val();
                                                                           let val_diag = $("#"+id_diag).val();
                                                                           let val_sol = $("#"+id_sol).val();

                                                                           if(val_el != "" && val_el == 1){
                                                                               tipo_falla_elemento += 1;
                                                                           }
                                                                           if(val_diag != "" && (val_diag == 4 || val_diag == 8825)){
                                                                               tipo_falla_diagnostico += 1;
                                                                           }

                                                                           if(val_sol != "" && (val_sol != 13 && val_sol != 14 && val_sol != 15 &&
                                                                                                val_sol != 16 && val_sol != 17 && val_sol != 18 &&
                                                                                                val_sol != 19 && val_sol != 20 && val_sol != 21 &&
                                                                                                val_sol != 22 && val_sol != 25)){
                                                                               let combo = document.getElementById(id_sol);
                                                                               tipo_falla_solucion = combo.options[combo.selectedIndex].innerText;
                                                                           }else{
                                                                               tipo_falla_solucion = "";
                                                                           }
                                                                    ...
                                                                    if (tipo_falla_count > 1) {
                                                                        $(".mensaje_modal").text("No puede haber mas de un elemento falla.");
                                                                        $('#modal_mensaje_error').modal('show');
                                                                        return false;
                                                                    }

                                                                    if (tipo_falla_count = 1 && tipo_falla_elemento >= 1) {
                                                                        $(".mensaje_modal").text("El elemento falla debe ser distinto de Motor completo.");
                                                                        $('#modal_mensaje_error').modal('show');
                                                                        return false;
                                                                    }

                                                                    if (tipo_falla_count = 1 && tipo_falla_diagnostico >= 1) {
                                                                        $(".mensaje_modal").text("El elemento falla no puede tener como diagnostico Confiabilidad o Indeterminado.");
                                                                        $('#modal_mensaje_error').modal('show');
                                                                        return false;
                                                                    }

                                                                    if (tipo_falla_count = 1 && tipo_falla_solucion != "") {
                                                                        $(".mensaje_modal").text("El elemento falla no puede tener como solución " + tipo_falla_solucion + ".");
                                                                        $('#modal_mensaje_error').modal('show');
                                                                        return false;
                                                                    }
                                                                }
                                                                /** FIN verifica elemento falla **/
                                                            ...
                                                            $(".submit-aprobar").click(function () {
                                                                ...
                                                                if(aplica_os && aplica_os.checked){
                                                                    if($("#os_sap").val() == "" || $("#os_sap").val() == 0) {
                                                                        $(".mensaje_modal").text("Debe ingresar un numero de OS SAP, si no aplica indiquelo en el check.");
                                                                        $('#modal_mensaje_error').modal('show');
                                                                        $("#os_sap").addClass("has-error");
                                                                        return false;
                                                                    }
                                                                }
                                                                 ...
                                                                 */
                                                                if ($("#yes_option_detail").is(':visible') && $("#no_option_detail").is(':visible') && !$("#yes_option_detail").is(':checked') && !$("#no_option_detail").is(':checked')) {
                                                                    todos = false;
                                                                ...
                                                                if (delta_negativo) {
                                                                    $(".mensaje_modal").text("No puede asignar valores negativos.");
                                                            ...
                                                            /** Verifica Elemento Falla en bitacora **/
                                                            var elementosFN = function () {
                                                                let tipocombo = $("#tipointervencion").val();
                                                                if(tipocombo != "RI" && tipocombo != "RP"){return false;}
                                                                ...
                                                                if (tipo_falla_count = 1 && (tipo_falla_elemento >= 1 || tipo_falla_diagnostico >= 1 || tipo_falla_solucion != "")){
                                                                    
                                                                    document.getElementById("alerta_elemento_falla").style.display = "block";
                                                                }else{
                                                                    document.getElementById("alerta_elemento_falla").style.display = "none";
                                                                }

                                                                if (tipo_falla_count > 1) {
                                                                    $(".elemento_falla").text("No puede haber mas de un elemento falla.");
                                                                    return false;
                                                                }

                                                                if (tipo_falla_count = 1 && tipo_falla_elemento >= 1) {
                                                                    $(".elemento_falla").text("El elemento falla debe ser distindo de Motor completo.");
                                                                    return false;
                                                                }

                                                                if (tipo_falla_count = 1 && tipo_falla_diagnostico >= 1) {
                                                                    $(".elemento_falla").text("El elemento falla no puede tener como diagnostico Confiabilidad o Indeterminado.");
                                                                    return false;
                                                                }

                                                                if (tipo_falla_count = 1 && tipo_falla_solucion != "") {
                                                                    $(".elemento_falla").text("El elemento falla no puede tener como solución " + tipo_falla_solucion + ".");
                                                                    return false;
                                                                }
                                                            }

                                                            $(".elemento-id, .diagnostico-id, .solucion-id, .tipo-id").change(function () {
                                                                elementosFN();
                                                            });
    ...
    <?php if (isset($estado) && $estado == "4" && $edt == "0") { ?>
                                                                        if (val != "") {
                                                                            $(".tecnico-id[id='" + id + "'] option[value!='" + val + "']").hide();
                                                                        }
    <?php } ?>
...
<?php if (isset($pautaPuestaMarcha) && $pautaPuestaMarcha == TRUE) { ?>
    ...
    <?php if (isset($estado) && $estado == "4" && (isset($edt) &&  $edt == "0")) { ?>
                                                                $("select, input, textarea").attr("disabled", "disabled");
    <?php } ?>
...
<?php if ($intervencion['Planificacion']['padre'] != NULL && $intervencion['Planificacion']['padre'] != '' && $cargos[$faena_session][0] != 4) { ?>
...
<?php } ?>
                                                    ...
                                                    /**
                                                     * añadido po Victor Smith
                                                     * sw = true, agrega 'required' a campos en sección nueva
                                                     * sw = false, elimina required
                                                     */
                                                    let evaluarRequired = (sw) => {
                                                        if (sw) {
                                                            ...
                                                            //
                                                            $('.delta_responsable_add_bitacora').each(function (index) {
