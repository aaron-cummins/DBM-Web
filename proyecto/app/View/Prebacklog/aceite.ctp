        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=7"><span class="widget-thumb-subtitle">SIN REVISAR</span></a>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=3"><span class="widget-thumb-subtitle">REVISADO</span></a>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=2"><span class="widget-thumb-subtitle">PLANIFICADO</span></a>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=11"><span class="widget-thumb-subtitle">REALIZADO</span></a>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=13"><span class="widget-thumb-subtitle">Cerrados</span></a>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            ...
            <div class="widget-thumb-wrap">
                ...
                <div class="widget-thumb-body">
                    <a href="/Prebacklog/aceite?estado_id=9"><span class="widget-thumb-subtitle">DESACTIVADO</span></a>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form" style="display: none;">
                <!-- BEGIN FORM-->
                <form action="/Prebacklog/aceite" class="horizontal-form" method="get">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="estado_id" id="estado_id">
                                        ...
                                        <option value="3" <?php echo @$estado_id == 3 ? "selected=\"selected\"" : ""; ?>>Revisado</option>
                    ...
                    <div class="form-actions right">
                        <button type="button" class="btn default" onclick="window.location = '/Preacklog/aceite';">Limpiar</button>
                        <button type="submit" class="dt-button buttons-print btn green-seagreen btn-outline" name="btn-descargar">
                            <i class="fa fa-file-excel-o"></i> Descargar Excel</button>
                        <button type="submit" class="dt-button buttons-print btn green-seagreen">
...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-helper">Prebacklog aceite en total <?php echo $total ?></span>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-print btn green-seagreen" tabindex="0" aria-controls="table_1" href="/Prebacklog/aceite"><i class="fa fa-eraser"></i> <span>Limpiar filtros</span></a>
                                <!--<a class="dt-button buttons-print btn green-seagreen btn-outline" tabindex="0" aria-controls="table_1" href="/Prebacklog/descarga_aceite"><i class="fa fa-file-excel-o"></i> <span>Descargar</span></a>-->
                                <a class="dt-button buttons-print btn green-seagreen" tabindex="0" aria-controls="table_1" href="/Prebacklog/prebacklog_aceite"><i class="fa fa-plus"></i> <span>Prebacklog Aceite</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    foreach ($registros as $registro) {
                                        ...
                                        echo "<td>";
                                            if($registro['Estado']['id'] == 7){
                                                echo    '<span class="label label-sm label-default">'. $registro['Estado']['nombre'].'</span>';
                                            }else if($registro['Estado']['id'] == 3){
                                                echo    '<span class="label label-sm label-warning">'. $registro['Estado']['nombre'].'</span>';
                                            }else if($registro['Estado']['id'] == 11){
                                                echo    '<span class="label label-sm label-success">'. $registro['Estado']['nombre'].'</span>';
                                            } else if($registro['Estado']['id'] == 9){
                                                echo    '<span class="label label-sm label-info">'. $registro['Estado']['nombre'].'</span>';
                                            } else if($registro['Estado']['id'] == 2){
                                                echo    '<span class="label label-sm label-primary">'. $registro['Estado']['nombre'].'</span>';
                                            }else if($registro['Estado']['id'] == 13){
                                                echo    '<span class="label label-sm bg-yellow-gold">'. $registro['Estado']['nombre'].'</span>';
                                            }
                                        ...
                                        #echo "<td>";
                                        echo '<a class="btn btn-sm blue tooltips" href="/Prebacklog/vista_aceite/' . $registro['Prebacklog']['id'] . '" data-container="body" data-placement="top" data-original-title="ver prebacklog"><i class="fa fa-eye"></i>  </a>';
                                        #echo "</td>";
...
<script type="text/javascript">
    ...
    function crea_backlog(id, tipo){
        if(confirm("Va a crear un Backlog, ¿esta seguro?")){
            window.location.href  = "/Backlog/web?idPrebacklog="+id+"&tipo="+tipo+"&validationes=C4m1l4YS4lV4DoRYA4r0N-ANZR6hkai1DCC";
        }else{
            return false;
        }
    }
    ...
    function validar(id, tipo, option){
        ...
        if(option == 1){
            if (confirm('el comentarios se guardara y Va a generar un nuevo backlog, ¿esta seguro?')){
                window.location.href  = "/Prebacklog/validar?idPrebacklog="+id+"&tipo="+tipo+"&option="+option+"&comentario="+$("#comentario_"+id).val();
            }else{
                $("#comentario_"+id).val("");
            }
        }else{
            if (confirm('el comentarios se guardara y se cerrara el prebacklog, ¿esta seguro?')){
                window.location.href  = "/Prebacklog/validar?idPrebacklog="+id+"&tipo="+tipo+"&option="+option+"&comentario="+$("#comentario_"+id).val();
            }else{
                $("#comentario_"+id).val("");
            }
