...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">Categoría Prebacklog</span>
        </div>
        <div class="tools"> </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dt-buttons">
                                <a class="dt-button buttons-print btn dark" tabindex="0" aria-controls="table_1" href="/PrebacklogCategoria/categoria"><i class="fa fa-plus"></i> <span>Nueva categoría</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12"> 
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <tr>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_categoria.id', 'ID') . "</th>"; ?>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_categoria.nombre', 'Nombre') . "</th>"; ?>
                                        <?php echo "<th>" . $paginator->sort('Prebacklog_categoria.fecha_creacion', 'Fecha Creacion') . "</th>"; ?>
                                        <th align="center">
                                        <?php
                                    ...
                                    foreach ($registros as $registro) {
                                        $registro['Prebacklog_categoria']['fecha_creacion'] = strtotime($registro['Prebacklog_categoria']['fecha_creacion']);
                                        $registro['Prebacklog_categoria']['fecha_creacion'] = date("d-m-Y", $registro['Prebacklog_categoria']['fecha_creacion']);


                                        echo "<td align=\"center\"><input type=\"hidden\" name=\"registro[{$registro['Prebacklog_categoria']['id']}]\" value=\"{$registro['Prebacklog_categoria']['e']}\">";
                                        echo "{$registro['Prebacklog_categoria']['id']}</td>";
                                        echo "<td>{$registro['Prebacklog_categoria']['nombre']}</td>";
                                        echo "<td>{$registro['Prebacklog_categoria']['fecha_creacion']}</td>";
                                        echo "<td align=\"center\" style=\"width: 60px;\">";
                                        echo '<div class="form-group" style="margin-bottom: 0;">';
                                        echo '<div class="mt-checkbox-inline">';
                                        echo '<label class="mt-checkbox mt-checkbox-outline">';
                                        if($registro['Prebacklog_categoria']['e'] == '1') {
                                                echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['Prebacklog_categoria']['id']}]\" value=\"1\" checked=\"checked\" />";
                                        } else {
                                                echo "<input type=\"checkbox\" class=\"check-option\" name=\"estado[{$registro['Prebacklog_categoria']['id']}]\" value=\"1\" />";
                                        }
                                        echo "<span></span>";
                                        echo "</label>";
                                        echo '</div>';
                                        ...
                                        echo "<td align=\"center\" style=\"width: 80px\">";
                                                echo $this->Html->link("Editar", array('action' => 'categoria', $registro['Prebacklog_categoria']['id']), array('class' => 'btn btn-sm blue'));
                                        echo "</td>";
                                        $i++;
                                        echo "</tr>";
                                    }
