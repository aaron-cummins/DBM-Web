				...
				<form action="" class="horizontal-form" method="post" role="form">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[nombre]" class="form-control" required="required" type="text" id="nombre" value="<?php echo $data["Faena"]["nombre"]; ?>">
							</div>
						</div>
					</div>	
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[codigo]" class="form-control" required="required" type="text" id="codigo" value="<?php echo $data["Faena"]["codigo"]; ?>">
							</div>
						</div>
					</div>	
					<div class="form-group">
							...
							<div class="col-md-4">
								<select class="form-control" name="data[zona_id]" required="required" id="zona_id"> 
									...
									<?php foreach($zonas as $key => $value) { ?>
										<option value="<?php echo $key;?>" <?php echo $data["Faena"]["zona_id"] == $key ? 'selected="selected"' : ''; ?>><?php echo $value;?></option>
									<?php } ?>
								</select> 
							</div>
						</div>
							...
							<div class="col-md-4">
								<select class="form-control" name="data[zona_numerica_id]" required="required" id="zona_numerica_id"> 
									...
									<?php foreach($zonas_numericas as $key => $value) { ?>
										<option value="<?php echo $key;?>" <?php echo $data["Faena"]["zona_numerica_id"] == $key ? 'selected="selected"' : ''; ?>><?php echo $value;?></option>
									<?php } ?>
								</select> 
							</div>
						</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<input name="data[altura]" class="form-control" required="required" type="number" id="altura" value="<?php echo $data["Faena"]["altura"]; ?>">
