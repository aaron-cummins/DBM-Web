<div class="row">
	...
	<div class="portlet light bordered">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="/Unidad/Editar/<?php echo $data["Unidad"]["id"]; ?>" class="horizontal-form" method="post" role="form">
					...
					<div class="form-group">
						<div class="row">
							<label for="flota_id" class="col-md-2 control-label">Flota/Equipo</label>
