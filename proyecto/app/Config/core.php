 ...
 */
	//if($this->Session->read("usuario_id") != null && $this->Session->read("usuario_id") == '629') {
 ...
 */
	Configure::write('Security.salt', '3EC9$pUiwQDr&q8xbYxOd8UVtfFF^3$2@E$Ree-9');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '07696192055532259016236226802381');
